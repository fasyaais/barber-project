...
function submit() {
    form.put(services.update(props.data.id).url, {
        forceFormData: true,
        onSuccess: () => {
            form.reset();
        },
...
<template>
    <div class="space-y-4">
        <div>
            <h1 class="text-2xl font-bold tracking-tight">Edit Layanan</h1>
            <p class="text-sm text-muted-foreground">Perbarui data layanan.</p>
        </div>
        <Card>
            <CardContent>
